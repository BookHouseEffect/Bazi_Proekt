...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Rezervacii : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Sedishta_Rezervacii", Storage="_Sedishta_SedishteId", ThisKey="SedishteId", OtherKey="SedishteId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PlanoviNaLetanje_Rezervacii", Storage="_PlanoviNaLetanje_PlanId", ThisKey="PlanId", OtherKey="PlanId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Patnici_Rezervacii", Storage="_Patnici_PatnikId", ThisKey="PatnikId", OtherKey="PatnikId", IsForeignKey=true)]
