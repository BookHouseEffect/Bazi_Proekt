...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Adresi : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"grad", Storage = "_Grad", DbType = "VARCHAR(255)", UpdateCheck = UpdateCheck.Never)]
        [System.ComponentModel.DataAnnotations.StringLength(255)]
        public string Grad
        {
            get
        ...
        /// </summary>
        [Column(Name = @"oblast", Storage = "_Oblast", CanBeNull = false, DbType = "VARCHAR(255) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        [System.ComponentModel.DataAnnotations.StringLength(255)]
        [System.ComponentModel.DataAnnotations.Required()]
