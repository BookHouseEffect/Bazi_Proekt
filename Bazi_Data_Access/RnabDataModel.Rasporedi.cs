...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Rasporedi : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Megjuletovi_Rasporedi", Storage="_Megjuletovi_MegjuletoviId", ThisKey="MegjuletoviId", OtherKey="MegjuletId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Denovi_Rasporedi", Storage="_Denovi_DenNaSletuvanje", ThisKey="DenNaSletuvanje", OtherKey="DenId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Denovi_Rasporedi1", Storage="_Denovi_DenNaPoletuvanje", ThisKey="DenNaPoletuvanje", OtherKey="DenId", IsForeignKey=true)]
