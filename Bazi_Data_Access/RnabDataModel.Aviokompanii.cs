...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Aviokompanii : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<Letovi> _Letovis_KompanijaId;
        ...
        public Aviokompanii()
        {
            ...
            this._Letovis_KompanijaId = new EntitySet<Letovi>(new Action<Letovi>(this.attach_Letovis_KompanijaId), new Action<Letovi>(this.detach_Letovis_KompanijaId));
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for Letovis_KompanijaId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Aviokompanii_Letovi", Storage="_Letovis_KompanijaId", ThisKey="KompanijaId", OtherKey="KompanijaId", DeleteRule="NO ACTION")]
        public EntitySet<Letovi> Letovis_KompanijaId
        {
            get
            {
                return this._Letovis_KompanijaId;
            }
            set
            {
                this._Letovis_KompanijaId.Assign(value);
            }
        }
        ...
        private void attach_Letovis_KompanijaId(Letovi entity)
        {
            this.SendPropertyChanging("Letovis_KompanijaId");
            entity.Aviokompanii_KompanijaId = this;
        }
    
        private void detach_Letovis_KompanijaId(Letovi entity)
        {
            this.SendPropertyChanging("Letovis_KompanijaId");
            entity.Aviokompanii_KompanijaId = null;
        }
