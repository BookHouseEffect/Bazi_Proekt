...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class PlanoviNaLetanje : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Megjuletovi_PlanoviNaLetanje", Storage="_Megjuletovi_MegjuletId", ThisKey="MegjuletId", OtherKey="MegjuletId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Avioni_PlanoviNaLetanje", Storage="_Avioni_AvionId", ThisKey="AvionId", OtherKey="AvionId", IsForeignKey=true)]
