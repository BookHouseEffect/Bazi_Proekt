...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Cenovnici : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Klasi_Cenovnici", Storage="_Klasi_KlasaId", ThisKey="KlasaId", OtherKey="KlasaId", IsForeignKey=true, DeleteOnNull=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PlanoviNaLetanje_Cenovnici", Storage="_PlanoviNaLetanje_PlanId", ThisKey="PlanId", OtherKey="PlanId", IsForeignKey=true, DeleteOnNull=true)]
