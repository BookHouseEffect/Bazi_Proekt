...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class DenoviNaLetanje : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Letovi_DenoviNaLetanje", Storage="_Letovi_LetId", ThisKey="LetId", OtherKey="LetId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Denovi_DenoviNaLetanje", Storage="_Denovi_DenId", ThisKey="DenId", OtherKey="DenId", IsForeignKey=true)]
