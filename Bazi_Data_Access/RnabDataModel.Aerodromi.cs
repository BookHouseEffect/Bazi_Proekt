...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Aerodromi : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Adresi_Aerodromi", Storage="_Adresi_AdresaId", ThisKey="AdresaId", OtherKey="AdresaId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Aerodromi_Megjuletovi", Storage="_Megjuletovis_AerodromDoId", ThisKey="AerodromId", OtherKey="AerodromDoId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Aerodromi_Megjuletovi1", Storage="_Megjuletovis_AerodromOdId", ThisKey="AerodromId", OtherKey="AerodromOdId", DeleteRule="NO ACTION")]
