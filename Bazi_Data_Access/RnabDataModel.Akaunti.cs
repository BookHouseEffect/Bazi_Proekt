...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Akaunti : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"akaunt_id", Storage = "_AkauntId", CanBeNull = false, DbType = "INT4 NOT NULL", IsPrimaryKey = true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Ulogi_Akaunti", Storage="_Ulogi_UlogaId", ThisKey="UlogaId", OtherKey="UlogaId", IsForeignKey=true)]
