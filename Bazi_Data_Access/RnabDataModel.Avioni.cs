...
namespace Db201617zVaProektRnabContext
{
    ...
    public partial class Avioni : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="TipNaAvioni_Avioni", Storage="_TipNaAvioni_TipId", ThisKey="TipId", OtherKey="TipId", IsForeignKey=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Aviokompanii_Avioni", Storage="_Aviokompanii_KompanijaId", ThisKey="KompanijaId", OtherKey="KompanijaId", IsForeignKey=true)]
