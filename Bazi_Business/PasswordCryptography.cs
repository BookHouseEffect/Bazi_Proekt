...
namespace Bazi_Business
{
    public class PasswordCryptography
    {
        public HashedAndSaltedPassword CryptPassword(string password, String defaultSalt = null)
        {
        ...
        public bool PasswordCompare(HashedAndSaltedPassword encryptedPassword, string plainPassword)
        {
        ...
        private byte[] GenerateSalt(int arrayLength = 64)
        {
